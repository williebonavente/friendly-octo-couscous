  ...
  code.selectTokensByType('Punctuator').forEach(function (token) {
    try {
      ...
      if (prevToken.isWhitespace) {
        ...
        var whitespaceBefore = new cst.Token('Whitespace', randomWhitespaceBefore);
...
function shittify(code) {
  ...
  var cst$1 = new cst.Parser().parse(modifiedCode);
  randomizeCase(cst$1);
  addRandomWhiteSpace(cst$1);
  return cst$1.getSourceCode();
}
...
var inputFileExtension = /*#__PURE__*/path.extname(inputFilePath.toString()).toLowerCase();
...
try {
  var code = /*#__PURE__*/fs.readFileSync(inputFilePath, 'utf-8');
  var shittifiedCode = /*#__PURE__*/shittify(code);
  fs.writeFileSync(outputFilePath, shittifiedCode, {
    encoding: 'utf-8',
...
//# sourceMappingURL=shittier.cjs.development.js.map
